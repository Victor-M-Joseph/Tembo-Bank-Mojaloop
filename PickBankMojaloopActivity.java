...
public class PickBankMojaloopActivity extends AppCompatActivity {
            ...
            public void onResponse(Response response0) throws IOException {
                ...
                try {
                    ...
                    if (success.equals(true)) {
                        ...
                        Intent intent = new Intent(PickBankMojaloopActivity.this, EnterOtpMojaloopActivity.class);
    ...
    private void  editAccountNumberMojaloopDialog(){
        ...
        Dialog dialog = new Dialog(PickBankMojaloopActivity.this);
